...
<head>
    ...
    <title>Train Ticket Bookings</title>
    <!-- google fonts -->
...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["pnr-search"]))
    {
        ...
        if($num)
        {
            ...
            <p>
                <button class="btn btn-sm btn-success"><a href="midtrans/examples/snap/checkout-process-simple-version.php?pnr=<?php echo $pnr; ?>" class="link-light">Bayar</a></button>
                ...
                <p class="mb-0">
                    <ul class="pnr-details">
                        ...
                        <li>
                            ...
                            <h4>IDR <?php echo $booked_amount; ?></h4>
                        </li>
                        <li>
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["deleteBtn"]))
        {
            ...
            $deleteSql = "DELETE FROM `bookings` WHERE `bookings`.`booking_id` = '$pnr'";
                ...
                {   
                    ...
                    $seats = get_from_table($conn, "seats", "kereta_no", $bus_no, "seat_booked");
                    ...
                    $updateSeatSql = "UPDATE `seats` SET `seat_booked` = '$seats' WHERE `seats`.`kereta_no` = '$bus_no';";
    ...
    <header>
        <nav>
            <div>
                    <a href="index.php" class="nav-item nav-logo">TKTI</a>
            ...
            <div>
                <a href="#" class="pnrnav-item" data-bs-toggle="modal" data-bs-target="#loginModal"><i class="fas fa-sign-in-alt" style="margin-right: 0.4rem;"></i>Login</a>
                <a href="#pnr-enquiry" class="pnrnav-item">PNR Enquiry</a>
            </div>
        </nav>
    </header>
    <!-- Login Modal -->
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Tiket Kereta Teknik Industri</h1>

            <p class="text-center">Welcome to Tiket Kereta Teknik Industri. Login now to manage train tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number). Web ini digunakan sebagai pemenuhan tugas mata kuliah Analisis Perancangan Sistem Informasi (APSI)</p>
    ...
    <div id="block">
        <section id="info-num">
            <figure>
                <img src="assets/img/baru/route.png" alt="Bus Route Icon" width="auto" height="100px">
                <figcaption>
            ...
            <figure>
                <img src="assets/img/baru/railway.png" alt="Bus Icon" width="auto" height="100px">
                <figcaption>
        ...
        <section id="about">
            <div>
                ...
                <p>
                    Web ini dibuat untuk memenuhi tugas praktikum mata kuliah Analisis Perancangan Sistem Informasi (APSI)
                </p>
                <p>Dosen Pengampu MK : Adhi Nugraha, S.T., M.BA.</p>
            </div>
        </section>
        <section id="contact">
            <div id="contact-form">
                ...
                <form action="">
                    <div>
                        ...
                        <h5 style="text-align: center;">
                            Muhammad Fauzi Pratama Hadiputra (20201014031111)
                        </h5>
                        <h5 style="text-align: center;">
                            Anggit Primayuda (202010140311109)
                        </h5>
                        <h5 style="text-align: center;">
                            Syarif Muhammad Fajri (202010140311110)
                        </h5>
                        <h5 style="text-align: center;">
                            Shafina Zahra D (202010140311108)
                        </h5>
                    </div>
                    <div>
                        <label for="message">Message</label>
                        <h4 style="text-align: center;">Tetaplah hidup meskipun itu susah!</h4>
                    </div>
                    <div></div>
                </form>
            </div>
