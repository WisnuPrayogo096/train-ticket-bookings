        ...
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                $customer_exists = exist_customers($conn,$cname,$cnik,$cusia,$cphone);
                $customer_added = false;
        
                if(!$customer_exists)
                {
                    // Route is unique, proceed
                    $sql = "INSERT INTO `customers` (`customer_name`, `nik`, `usia`, `customer_phone`, `customer_created`) VALUES ('$cname', '$cnik', '$cusia', '$cphone', current_timestamp());";
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addCustomerForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="cnik" class="form-label">NIK</label>
                                <input type="text" class="form-control" id="cnik" name="cnik">
                            </div>
                            <div class="mb-3">
                                <label for="cusia" class="form-label">Umur</label>
                                <input type="text" class="form-control" id="cusia" name="cusia">
                            </div>
                            <div class="mb-3">
