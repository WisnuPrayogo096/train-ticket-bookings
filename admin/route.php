    ...
    <?php
        ...
        */
        ...
        <?php
            ...
            <?php
                $busSql = "SELECT kereta_no FROM kereta WHERE kereta_assigned=0";
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addRouteForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="busno" class="form-label">Train Number</label>
