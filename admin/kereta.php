        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                if(!$bus_exists)
                {
                    ...
                    $sql = "INSERT INTO `kereta` (`kereta_no`, `kereta_created`) VALUES ('$busno', current_timestamp());";
                ...
                if($bus_added)
                {
                    ...
                    <strong>Successful!</strong> Trains Information Added
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                    // Add the bus to seats table
                    $seatSql = "INSERT INTO `seats` (`kereta_no`) VALUES ('$busno');";
            ...
            if(isset($_POST["edit"]))
            {
                ...
                {
                    $updateSql = "UPDATE `kereta` SET `kereta_no` = '$busno' WHERE `kereta`.`id` = $id;";
                    ...
                    elseif($updateResult)
                    {
                        ...
                        $messageInfo = "Trains details Edited";
                    }
                    else{
                        // Show error alert
                ...
                else 
                {
                    ...
                    echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> Trains details already exists
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            ...
            if(isset($_POST["delete"]))
            {
                // DELETE BUS
                $id = $_POST["id"];
                $bus_no = get_from_table($conn, "kereta", "id", $id, "kereta_no");
                // Delete the bus with id => id
                $deleteSql = "DELETE FROM `kereta` WHERE `kereta`.`id` = $id";
                ...
                {   
                    ...
                    // Show success alert
                    $messageStatus = "success";
                    $messageInfo = "Trains Details deleted";
                    $messageHeading = "Successfull!";

                    // Delete Bus from Seat table
                    $sql = "DELETE from seats WHERE kereta_no='$bus_no'";
        ...
        ?>
        <?php
            $resultSql = "SELECT * FROM `kereta` ORDER BY kereta_created DESC";
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">No Trains found!</h1>
                        <p class="fw-light">Be the first person to add one!</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Click on <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ADD <i class="fas fa-plus"></i></button> to add a trains!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="bus">
                ...
                <div id="bus-results">
                    <div>
                        <button id="add-button" class="button btn-sm" type="button"data-bs-toggle="modal" data-bs-target="#addModal">Add Train Details <i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add A Train</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="addBusForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                <label for="busnumber" class="form-label">Train Number</label><br>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    Do you really want to delete this trains? <strong>This process cannot be undone.</strong>
                </p>
                <!-- Needed to pass id -->
